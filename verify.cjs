...
console.log('Coverage',counts);if(counts.some(n=>n<5))throw Error('insufficient case coverage');console.log('PASS syntax, move identities, all eleven inverse-sequence examples, independent legal matching cases:',counts);
`,{console});
